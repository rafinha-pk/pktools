...
class Ui_Rede(object):
    def setupUi(self, Rede):
        ...
        self.valor_local_2 = QtWidgets.QLabel(Rede)
        self.valor_local_2.setGeometry(QtCore.QRect(200, 40, 61, 17))
        self.valor_local_2.setWordWrap(False)
        self.valor_local_2.setTextInteractionFlags(QtCore.Qt.TextSelectableByKeyboard|QtCore.Qt.TextSelectableByMouse)
        self.valor_local_2.setObjectName("valor_local_2")
    ...
    def retranslateUi(self, Rede):
        ...
        self.valor_local_2.setText(_translate("Rede", "X"))
